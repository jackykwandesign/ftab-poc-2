...
export const FAutoConvertArray = <T,>(
...
export const useTabConroller = (props?: {
    initKey?: string
}): TabController => {
    const { initKey } = props ?? {}
        ...
        <div>
            {panelProps.map((e) => {
                ...
                return (
                    <button
                        key={e.tabKey}
                        onClick={() => controller.setTabKey(e.tabKey)}
                        style={{
